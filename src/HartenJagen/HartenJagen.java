...
public class HartenJagen extends Game {
    ...
    private CardsPlayer<SlagTable> cardsPlayer = new CardsPlayer<>();
    ...
    public void playRound() {
        ...
        cardsPlayer.playAllCards((HJTable)table, new HighestCardSameColour());
        //calculate the score

        //TODO:
        //prepare for the next round
        nextRoundPreparer.prepareNextRound((HJTable) table);
    }
